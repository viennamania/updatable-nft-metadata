...
const addNFTs = async () => {
  ...
  try {
    await drop.createBatch([
      "https://my-json-server.typicode.com/viennamania/updatable-nft-metadata/nfts/63",
      "https://my-json-server.typicode.com/viennamania/updatable-nft-metadata/nfts/64",
    ]);
